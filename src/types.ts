export type GameMode = "original-quick-draw" | "word-duel";
export type WordDuelPhase = "menu" | "waiting" | "word" | "result";
export type OriginalQuickDrawPhase = "menu" | "waiting" | "draw" | "result";
export type RoundPhase = WordDuelPhase | OriginalQuickDrawPhase;
...
export type Round = WordDuelRound | OriginalQuickDrawRound;
